        ...
        info = @Info(
                ...
                extensions = {
                        @Extension(properties = {
                                @ExtensionProperty(name = "name", value = "linuxdevice"),
                                @ExtensionProperty(name = "context", value = "/linuxdevice"),
                        })
                }
        ),
        tags = {
                @Tag(name = "linuxdevice,device_management", description = "")
        }
)
@Scopes(
        scopes = {
                @Scope(
                        name = "Enroll device",
                        description = "",
                        key = "perm:linuxdevice:enroll",
                        permissions = {"/device-mgt/devices/enroll/linuxdevice"}
                )
        }
)
