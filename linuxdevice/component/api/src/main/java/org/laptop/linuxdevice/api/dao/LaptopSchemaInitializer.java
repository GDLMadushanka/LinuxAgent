 ...
 */
public class LaptopSchemaInitializer extends DatabaseCreator{

	private static final Log log = LogFactory.getLog(LaptopSchemaInitializer.class);
	...
	public LaptopSchemaInitializer(DataSource dataSource) {
		super(dataSource);
	}
