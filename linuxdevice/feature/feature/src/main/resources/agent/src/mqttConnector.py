...
def main():
    ...
    # TOPIC_TO_SUBSCRIBE --> carbon.super/laptop/+/data
    ...
    while True:
        try:
            ...
            # test -  RASPBERRY_STATS: global name 'mqttClient' is not defined
