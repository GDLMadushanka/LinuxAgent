...
MERGE INTO linuxdevice_PROFILES KEY (ID) VALUES (2, 'profileid2', 'Lenovo8GB','Lenovo','2.0 Quad core', '8GB','500GB','Ubuntu','' );
MERGE INTO linuxdevice_PROFILES KEY (ID) VALUES (3, 'profileid3', 'Mac8GB','Apple', 'i7 dual core', '16GB','500GB','Mac','' );
MERGE INTO linuxdevice_PROFILES KEY (ID) VALUES (4, 'profileid4', 'Dell8GB','Dell', 'i5 dual core', '8GB','250GB','Win 8','' );
MERGE INTO linuxdevice_PROFILES KEY (ID) VALUES (5, 'profileid5', 'Toshiba8GB','Toshiba', '2.0 Quad core', '16GB','500GB','Ubuntu','' );
